...
class UserAccount
{
  ...
  public function browse_user_accounts(
    $sort_field = false, $sort_order = 'DESC', $start_record = 0, $stop_record = 20, $search = false, $user_account_id = false)
  {
      $sort = "";
      $search_sql = "";
      $pdo_params = array();
  ...
  public function insert_update_user_account(
    $data, $user_account_id, $update_groups = true, $proxy_role_id = false, $role_perm_manage_all_accounts_access = false
  ) {
      // Update
    $statement = $this->db->prepare("
      UPDATE user_account
