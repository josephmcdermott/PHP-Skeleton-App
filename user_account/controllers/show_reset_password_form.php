...
function show_reset_password_form()
{
  ...
  if (isset($_SESSION[$final_global_template_vars["session_key"]])) {
    ...
    "page_title" => "Reset Password", "hide_page_header" => true, "path_to_this_module" => $final_global_template_vars["path_to_this_module"], "errors" => $env["default_validation_errors"]
  ));
}
