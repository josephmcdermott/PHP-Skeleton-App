...
function verify_email(){
  ...
  if( $error[0] != "00000" )
  {
    var_dump( $db_resource->errorInfo() ); die('The SELECT FROM user_account failed.');
  }
  ...
  if($data) {
    ...
    if( $error[0] != "00000" )
    {
      var_dump( $db_resource->errorInfo() ); die('The UPDATE user_account active flag.');
    }
  ...
  $app->render('verify_email.php',array(
